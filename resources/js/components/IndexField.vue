<template>
  <div class="flex items-center">
    ...
    >
      <!-- <svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="fill-transparent">
